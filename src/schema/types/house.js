  ...
  fields: () => {
    ...
    return {
      ...
      cadetBranches: {
        ...
        resolve: (parentVal, args) => getDataListById(houseJSON, parentVal.CadetBranches)
      },
  
      CurrentLord: {
        type: charType,
        resolve: (parentVal, args) => getDataById(charactersJSON, parentVal.CurrentLord)
      },
  
      founder: {
        type: charType,
        description: 'Name of the founder of the house',
        resolve: (parentVal, args) => getDataById(charactersJSON, parentVal.Founder)
      },
  
      heir: {
        type: charType,
        description: 'Heir of the house',
        resolve: (parentVal, args) => getDataById(charactersJSON, parentVal.Heir)
      }
      }
    }      
})
